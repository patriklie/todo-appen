    ...
    <>
      ...
      <div className='buttons-container'>
        <div className="button-container" onClick={() => setAddTodoActive(!addTodoActive)}>
          <IconContainer onClick={() => setAddTodoActive(!addTodoActive)} iconName={"wired-outline-49-plus-circle"} reveal={"in-reveal"} hover={"hover-rotation"} size={35} />
          <div className='button-container-text'>Add todo</div>
        </div>

        <div className="button-container" onClick={handleDeleteList}>
          <IconContainer onClick={handleDeleteList} iconName={"wired-outline-185-trash-bin"} reveal={"in-reveal"} hover={"hover-empty"} size={35} />
          <div className='button-container-text'>Slett liste</div>
        </div>

        <div className="button-container" onClick={handleDeleteAllTodos}>
          <IconContainer onClick={handleDeleteAllTodos} iconName={"wired-outline-1683-recycling"} reveal={"in-reveal"} hover={"hover-cycle"} size={35} />
